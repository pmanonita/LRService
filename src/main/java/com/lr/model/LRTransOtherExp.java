...
public class LRTransOtherExp implements Serializable {
	...
	public LRTransOtherExp() {	}
	
	public LRTransOtherExp (Controller ctrl) {
		createFrom(ctrl);		
	}
	...
	private static final String QUERY_FOR_LRTRANSOTHEREXPENDITURE_BY_ID_SKEY =
		LRTransOtherExp.class.getName() + ".findLRTransOtherExpenditureById";	
	public static LRTransOtherExp findLRTransOtherExpenditureById(Session session, Long id)
		throws HibernateException
	{
	 	...
	 	Query qry = session.getNamedQuery(QUERY_FOR_LRTRANSOTHEREXPENDITURE_BY_ID_SKEY);
	 	qry.setLong("id", id);		 	
 
	 	qry.setMaxResults(1);
 
	 	final LRTransOtherExp lrOther = (LRTransOtherExp)(qry.uniqueResult());
	 	return lrOther;
	}
